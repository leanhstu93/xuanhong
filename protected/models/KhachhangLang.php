 ...
 */
class KhachhangLang extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('idNgonNgu, idKhachHang', 'numerical', 'integerOnly'=>true),
			array('Name, Alias', 'length', 'max'=>255),
			array('Description, Content', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, idNgonNgu, idKhachHang, Name, Alias, Description, Content', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('idKhachHang',$this->idKhachHang);
