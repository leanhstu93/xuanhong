...
<?php echo $form->errorSummary($model); ?>
 <div class="form-group" style="margin-bottom:0px">
    ...
    <div class="col-sm-6">
          <?php
          echo $form->dropDownList($model, 'Type',array("Banner","Hình ảnh công ty"), array( 'class' => 'form-control ')); ?>
...
<div class="form-group" style="margin-bottom:0px">
 ...
 <div class="tt_ta">
    ...
    <label class="col-sm-2 control-label form-label" for="input001">Tiêu đề:</label>
    <div class="col-sm-6">
        <?php echo $form->textField($sli_,'Name',array('name'=>'SlideLang_[Name]','size'=>60,'maxlength'=>100,'class'=>'form-control')); ?>
        <span class="help-block" id="helpBlock"><?php echo $form->error($model,'Name',array("text"=>"aaa")); ?></span> </div>
</div>
<div class="form-group" style="margin-bottom:0px">
    <label class="col-sm-2 control-label form-label" for="input001">Mô tả:</label>
    <div class="col-sm-6">
        <?php echo $form->textArea($sli_,'Description',array('name'=>'SlideLang_[Description]','size'=>60,'maxlength'=>100,'class'=>'form-control')); ?>
        <span class="help-block" id="helpBlock"><?php echo $form->error($model,'Description',array("text"=>"aaa")); ?></span> </div>
</div>
</div>
