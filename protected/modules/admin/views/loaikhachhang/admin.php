...
<div class="page-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"><a href="<?php echo Yii::app()->homeUrl ?>admin/quan-ly-loai-tin.html">Quản lý loại khách hàng </a></li>
    </ol>
</div>
<!-- End Page Header -->
        ...
        <div class="col-md-12">
            <div class="panel panel-default ad-qllt">
                <div class="panel-title">
                    ...
                    <a class="btn btn-default createCourse" href="<?php echo Yii::app()->request->baseUrl ?>/admin/them-loai-khach-hang.html">Thêm loại khách hàng</a>
                </div>
                                ...
                                array(
                                    ...
                                    'buttons' => array(
                                        'update' => array(
                                            ...
                                            'url' =>'Yii::app()->homeUrl."admin/sua-loai-khach-hang/".$data->id.".html"'
                                        ),
                                        'delete' => array(
                                            'label' => '',
                                            'imageUrl' => '',
                                            'url'=>'Yii::app()->homeUrl."admin/loaikhachhang/delete/id/".$data->id.".html"',
