...
<div class="page-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"><a href="/admin/quan-ly-bai-viet.html">Quản lý banner </a></li>
    </ol>
</div>
<!-- End Page Header -->
        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-title">
                    ...
                    <a class="btn btn-default createCourse" href="<?php echo Yii::app()->request->baseUrl ?>/admin/them-banner.html">Thêm banner</a>
                </div>
                        ...
                        $this->widget('zii.widgets.grid.CGridView', array(
                            ...
                            'columns' => array(
                               ...
                               array(
                                    "name"=>"SetHome",
                                    "type"=>"raw",
                                    "value"=>'$data->SetHome == 1?"<span class=\"fa fa-check\"></span>":""',
                                    "htmlOptions"=>array("style"=>"text-align:center;color:#399bff;font-size:30px")
                                ),
                                array(
                                    'class' => 'CButtonColumn',
