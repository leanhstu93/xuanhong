        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-title">
                    ...
                    <a class="btn btn-default createCourse" href="<?php echo Yii::app()->request->baseUrl ?>/admin/them-news.html">Thêm tin tức</a>
                </div>
                        ...
                        $this->widget('zii.widgets.grid.CGridView', array(
                            ...
                            'columns' => array(
                                ...
                                array(
                                    "name"=>"HinhAnh",
                                    "type"=>"raw",
                                    "value"=>'"<img style=\"width:100%\" src=\"".$data->HinhAnh."\"/>"',
