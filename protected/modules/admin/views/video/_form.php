...
<div class="tt_tv">
    <div class="form-group" style="margin-bottom:0px">
        ...
        <div class="col-sm-6">
            <?php echo $form->textField($video,'Name',array('size'=>60,'maxlength'=>100,'class'=>'form-control')); ?>
            <span class="help-block" id="helpBlock"><?php echo $form->error($video,'Name',array("text"=>"aaa")); ?></span> </div>
    </div>
</div>
<div class="tt_ta">
    <div class="form-group" style="margin-bottom:0px">
        <label class="col-sm-2 control-label form-label" for="input001">Tiêu đề:</label>
        <div class="col-sm-6">
            <?php echo $form->textField($video_,'Name',array('name'=>'VideoLang_[Name]','size'=>60,'maxlength'=>100,'class'=>'form-control')); ?>
            <span class="help-block" id="helpBlock"><?php echo $form->error($video,'Name',array("text"=>"aaa")); ?></span> 
        </div>
    </div>
</div>
